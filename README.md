...
- **Preference models** multi-head pairwise reward models on a Qwen2.5-3B backbone, trained here on the human labels.
...
notebooks/
  ...
  05_local-experiments     LP solves + Claude judging
  06_results               figures and summary tables
tests/               pytest suite
```
